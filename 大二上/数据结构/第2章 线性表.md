...
<img src="C:\Users\86133\Desktop\学习\dio图表\数据结构\线性表.drawio.svg" alt="线性表.drawio"  />
...
- 使用C语言中的数组表示顺序表，结构体存储表信息：
  ...
  <img src="C:\Users\86133\Desktop\学习\dio图表\数据结构\线性表-顺序表.drawio.svg" alt="线性表-顺序表.drawio"  />
...
- 每个结点均含有两个域：存放元素的**数据域**和存放其后继结点的**指针域**。
  ...
  ![线性表-结点结构.drawio](C:\Users\86133\Desktop\学习\dio图表\数据结构\线性表-结点结构.drawio.svg)
...
- 定义
  ...
  <img src="C:\Users\86133\Desktop\学习\dio图表\数据结构\线性表-链表.drawio.svg" alt="线性表-链表.drawio"  />
...
![线性表-头结点.drawio](C:\Users\86133\Desktop\学习\dio图表\数据结构\线性表-头结点.drawio.svg)
...
![线性表-单链插入.drawio](C:\Users\86133\Desktop\学习\dio图表\数据结构\线性表-单链插入.drawio.svg)
...
![线性表-单链删除.drawio](C:\Users\86133\Desktop\学习\dio图表\数据结构\线性表-单链删除.drawio.svg)
...
- 循环链表中**最后一个结点的指针域指向头结点**，整个链表形成一个环
  ...
  ![线性表-循环链表.drawio](C:\Users\86133\Desktop\学习\dio图表\数据结构\线性表-循环链表.drawio.svg)

> 合并两个循环链表

![线性表-循环合并.drawio](C:\Users\86133\Desktop\学习\dio图表\数据结构\线性表-循环合并.drawio.svg)
...
- 缺点：空间开销大
  ...
  ![线性表-双向链表.drawio](C:\Users\86133\Desktop\学习\dio图表\数据结构\线性表-双向链表.drawio.svg)
...
- **双向循环链表**
  ...
  - `p -> prior == p == p -> next`
    ...
    ![线性表-双向循环.drawio](C:\Users\86133\Desktop\学习\dio图表\数据结构\线性表-双向循环.drawio.svg)

### 插入

![线性表-双向插入.drawio](C:\Users\86133\Desktop\学习\dio图表\数据结构\线性表-双向插入.drawio.svg)
...
![线性表-双向删除.drawio](C:\Users\86133\Desktop\学习\dio图表\数据结构\线性表-双向删除.drawio.svg)
...
![线性表-栈.drawio](C:\Users\86133\Desktop\学习\dio图表\数据结构\线性表-栈.drawio.svg)
...
- **应用**
  ...
  - **数制转换**
    ...
    <img src="C:\Users\86133\Desktop\学习\dio图表\数据结构\线性表-数制转换示例.drawio.svg" alt="线性表-数制转换示例.drawio"  />
...
<img src="C:\Users\86133\Desktop\学习\dio图表\数据结构\线性表-队列.drawio.svg" alt="线性表-队列.drawio"  />
...
- 当`front==rear`时，表示空队列。
  ...
  ![线性表-循环队列.drawio](C:\Users\86133\Desktop\学习\dio图表\数据结构\线性表-循环队列.drawio.svg)
...
![线性表-链队列.drawio](C:\Users\86133\Desktop\学习\dio图表\数据结构\线性表-链队列.drawio.svg)
...
- **基本操作**
  ...
  - **入队**
    ...
    ![线性表-链队列入队.drawio](C:\Users\86133\Desktop\学习\dio图表\数据结构\线性表-链队列入队.drawio.svg)
  ...
  - **出队**
    ...
    ![线性表-链队列出队.drawio](C:\Users\86133\Desktop\学习\dio图表\数据结构\线性表-链队列出队.drawio.svg)
